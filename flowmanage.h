...
public:
    ...
    uint8_t sport;
    uint8_t dport;
    flowmanage(const uint32_t &ip_src, const uint32_t &ip_dst, const uint8_t &sport, const uint8_t &dport)
    {
        this->ip_src = ip_src;
        this->ip_dst = ip_dst;
        this->sport = sport;
    ...
    void init(const uint32_t &ip_src, const uint32_t &ip_dst, const uint8_t &sport, const uint8_t &dport)
    {
        this->ip_src = ip_src;
        this->ip_dst = ip_dst;
        this->sport = sport;
